<%-- 
    Document   : home.view
    Created on : Jun 16, 2025, 9:25:54 PM
    Author     : v14
--%>
...
<div class="dashboard-wrapper d-flex">
    ...
    <div class="main-content p-4 flex-fill">
        <div class="neo-card p-4">
            <h1 class="neo-title">Halo, ${fullname}</h1>
            <p>Selamat datang di dashboard Toko ATK</p>
            <a href="userlist.jsp" class="btn neo-btn mt-3">Lihat Daftar User</a>
        </div>
    </div>
</div>
    <script>
